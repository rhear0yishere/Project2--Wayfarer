...
changeLondon= () => {
  let context = this;
      this.setState({
          ...
          context.fetch(this.state.title); 
        });
...
changeSanFran= () => {
  ...
  fetch(city) {
    ...
    let tips = [
      ...
      "tip": {"author": "chike", "image": "", "title": "chike title", "text":"xyz", "city": "Seattle"}},
      
      {"user": {"email": "eunice@gmail.com", "password": "something2"},
      "tip": {"author": "eunice", "image": "", "title": "eunice title", "text":"xyz", "city": "London"}},
      
      {"user": {"email": "tristan@gmail.com", "password": "something3"},
      "tip": {"author": "tristan", "image": "", "title": "tristan title", "text":"xyz", "city": "San Francisco"}},
      ...
      tips = tips.filter((aTip, index)=>{
        return aTip.tip.city === city;
      });
