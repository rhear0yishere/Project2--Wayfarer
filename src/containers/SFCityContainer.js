...
changeSanFran= () => {
  ...
  fetch() {
    let tips = [
      ...
      "tip": {"author": "chike", "image": "", "title": "chike title", "city": "Seattle"}},
      
      {"user": {"email": "eunice@gmail.com", "password": "something2"},
      "tip": {"author": "eunice", "image": "", "title": "eunice title", "city": "London"}},
      
      {"user": {"email": "tristan@gmail.com", "password": "something3"},
      "tip": {"author": "tristan", "image": "", "title": "tristan title", "city": "San Francisco"}},
